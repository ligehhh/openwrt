...
sed -i '/<tr><td width="33%"><%:Compiler author/a <tr><td width="33%"><%:Firmware Update%></td><td><a target="_blank" href="https://github.com/ligehhh/openwrt/releases">https://github.com/ligehhh/openwrt/releases</a></td></tr>' package/lean/autocore/files/x86/index.htm #添加固件更新地址
