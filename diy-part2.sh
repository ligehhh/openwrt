...
sed -i '/<tr><td width="33%"><%:CPU usage/a <tr><td width="33%"><%:oopp%></td><td > <iframe width="700" height="100" frameborder="0" scrolling="no" hspace="0" src="//ip.skk.moe/simple"></iframe> #添加测速IP地址
...
sed -i '/<tr><td width="33%"><%:Firmware Update/a <tr><td width="10%"><%:Urban weather%></td><td > <iframe width="900" height="120" frameborder="0" scrolling="no" hspace="0" src="//i.tianqi.com/?c=code&a=getcode&id=22&py= &icon=1"></iframe> #添加天气
